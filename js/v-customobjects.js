...
Vue.component("obj-head", {
	template: `<a-entity>
		<a-sphere 
			...
			>
			<obj-axes scale=".1 .0 .0" v-if="false" />
		</a-sphere>
    

    <a-cone color="tomato" radius-bottom="0.2" radius-top="0.01">
    <a-sphere
        :color="obj.color.toHex()"
        side="double"
        position="0, 0.5, 0"
...
Vue.component("obj-world", {
	...
	<a-entity>
		<!--------- SKYBOX --------->
		<a-sky src=#sky></a-sky>
      <a-gltf-model position="0 0 -3" animation="dur:6000;from:0 0 -3; to:0 10 -3;loop:-1;property:position" light="type: point; intensity: 0.5; position:0 15 -3;" shadow="cast: true" src="https://cdn.glitch.global/0c9fae25-6303-4939-b655-fb5b8368a3bf/out.glb?v=1654748817545">
